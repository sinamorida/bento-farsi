...
// once per catalog. Regenerate after editing any catalog:
//
...
registerI18n({
  packed: {
    ...
    alias: {
      ...
      'zh-HK': 'zh-Hant',
      'zh-MO': 'zh-Hant',
      // Brazilian terminology; pt-PT maps here the way slides maps it
 ...
 * the VIEWER; the document does not mirror — its prose keeps the reading order
 * it was written with, whatever the editing tools around it are doing.
 */
