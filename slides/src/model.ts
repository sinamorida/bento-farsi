...
export const FONT_STACK =
  "'Vazirmatn', 'Vazir', 'IRANSans', 'IRANYekan', 'Sahel', 'Samim', 'Shabnam', 'B Yekan', 'B Nazanin', 'Segoe UI', Tahoma, -apple-system, BlinkMacSystemFont, Roboto, Helvetica, Arial, sans-serif"

export const MONOSPACE_FONT_STACK =
  "'Vazir Code', 'Shabnam Code', 'Vazirmatn', ui-monospace, 'SFMono-Regular', 'Berkeley Mono', 'Menlo', 'Consolas', monospace"
...
export function defaultText(partial: Partial<TextElement> = {}): TextElement {
  return {
    ...
    html: 'برای ویرایش متن دو بار کلیک کنید',
    fontSize: 32,
